...
const ImagePg=()=>{
    ...
    return (
       <div className="flex gap-2 max-md:flex-wrap overflow-x-auto  max-lg:flex-row max-sm:justify-center max-lg:flex-wrap">
       <div>
        <p className="text-gray-500 text-xl font-serif overflow-hidden font-semibold">CHOOSE ANOTHER STORY</p>
       </div>
       <div>
